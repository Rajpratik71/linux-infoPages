File: *manpages*,  Node: amdump_client,  Up: (dir)
...
DESCRIPTION
       Amdump_client initiate backup on the client. There are three commands
       (CMD):
       ...
       dump
           Start a backup of the specified diskname, or all diskname if none
           are specified.
