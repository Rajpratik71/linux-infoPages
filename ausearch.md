File: *manpages*,  Node: ausearch,  Up: (dir)
...
OPTIONS
       ...
       --checkpoint checkpoint-file
              ...
              Should the file or checkpointed completed event not be found, an
              error will result and ausearch will terminate.
   ...
   Exit status:
       0      if OK, 1 if nothing found, or  argument  errors  or  minor  file
              acces/read  errors,  10  bad checkpoint data, 11 checkpoint pro-
              cessing error
