File: *manpages*,  Node: btrfs,  Up: (dir)
...
SEE ALSO
       mkfs.btrfs(8), ionice(1), btrfs-balance(8), btrfs-check(8),
       ...
       btrfs-send(8), btrfs-subvolume(8),
...
MOUNT OPTIONS
       ...
       flushoncommit, noflushoncommit
           ...
           application’s perspective (i.e., it includes all completed file
           system operations). This was previously the behavior only when a
...
Btrfs v4.5.3+20160729             11/14/2016                     BTRFS-MAN5(5)
