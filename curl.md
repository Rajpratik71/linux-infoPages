File: *manpages*,  Node: curl,  Up: (dir)
...
OPTIONS
       ...
       -1, --tlsv1
              ...
              --tlsv1.2, and --tlsv1.3 to control the TLS  version  more  pre‐
              cisely  (if the SSL backend in use supports such a level of con‐
              trol).
       ...
       --tlsv1.3
              (SSL) Forces curl to use TLS version 1.3 when negotiating with a
              remote TLS server.  (Added in 7.52.0)
       ...
       See also --tlsv1.0 and --tlsv1.1 and --tlsv1.2 and --tlsv1.3.  Added in
       7.54.0.
