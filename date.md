...
`--rfc-3339=TIMESPEC'
     ...
     This format is always suitable as input for the `--date' (`-d')
     and `--file' (`-f') options, regardless of the current locale.
...
27.5 Combined date and time of day items
========================================
...
27.7 Relative items in date strings
===================================
...
27.8 Pure numbers in date strings
=================================
...
27.10 Specifying time zone rules
================================
...
27.11 Authors of `parse_datetime'
=================================
