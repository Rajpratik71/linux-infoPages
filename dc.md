...
Next: Invocation,  Prev: Top,  Up: Top
...
Next: Arithmetic,  Prev: Invocation,  Up: Top
...
Next: Stack Control,  Prev: Printing Commands,  Up: Top
...
'|'
     ...
     command will work with arbritrarily large exponents.  (This command
     is a GNU extension.)
...
Next: Strings,  Prev: Registers,  Up: Top
...
Next: Reporting bugs,  Prev: Status Inquiry,  Up: Top
