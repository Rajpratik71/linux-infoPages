File: *manpages*,  Node: dhclient,  Up: (dir)
...
SYNOPSIS
       ...
       -P...  ] ] [ -i ] [ -I ] [ -D LL|LLT ] [ -H hostname ] [ -p port-number
       ]  [ -d ] [ -df duid-lease-file ] [ -e VAR=value ] [ -q ] [ -1 ] [ -r |
       -x ] [ -lf lease-file ] [ -pf pid-file ] [ --no-pid ] [ -cf config-file
       ]  [ -sf script-file ] [ -s server-addr ] [ -g relay ] [ -n ] [ -nw ] [
       -w ] [ -v ] [ --version ] [ if0 [ ...ifN ] ]
...
OPTIONS
       ...
       -H hostname
              This flag may be used to specify a client hostname  that  should
              be  sent  to the DHCP server as host-name (ipv4 only) or fqdn to
              perform dns update.  Note, that this  option  is  a  SUSE/Novell
              extension.
