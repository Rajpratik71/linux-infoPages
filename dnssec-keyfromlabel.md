File: *manpages*,  Node: dnssec-keyfromlabel,  Up: (dir)
...
SYNOPSIS
       dnssec-keyfromlabel {-l label} [-3] [-a algorithm] [-A date/offset]
                           [-c class] [-D date/offset] [-D sync date/offset]
                           [-E engine] [-f flag] [-G] [-I date/offset]
                           [-i interval] [-k] [-K directory] [-L ttl]
                           [-n nametype] [-P date/offset]
                           [-P sync date/offset] [-p protocol]
                           [-R date/offset] [-S key] [-t type] [-v level] [-V]
                           [-y] {name}
...
OPTIONS
       -a algorithm
           ...
           RSASHA512, ECCGOST, ECDSAP256SHA256, ECDSAP384SHA384, ED25519 or
           ED448. These values are case insensitive.
...
COPYRIGHT
       Copyright © 2008-2012, 2014-2018 Internet Systems Consortium, Inc.
       ("ISC")
