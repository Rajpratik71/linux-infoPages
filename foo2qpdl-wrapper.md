...
COMMAND LINE OPTIONS
   ...
   Printer Tweaking Options
       ...
       -L mask
              Send the logical clipping values from -u/-l in the QPDL stream.  foo2qpdl-wrapper always runs Ghostscript with the ideal page dimensions, so that the scale of the image is correct, regardless
   ...
   Color Tweaking Options
       ...
       -a parm=val
              Color Adjust.  parm is b, c, s, cr, mg, yb for brightness, contrast, saturation, cyan-red balance, magenta-green balance, and yellow-blue balance.  val is 0 to 100.  Multiple options are  al‐
              lowed.  The default is "-ab=50 -ac=50 -as=50 -acr=50 -amg=50 -ayb=50".  This only works when the -z3 (e.g. CLP-365) model is set!
