File: gcc-4.8.info,  Node: Gcov,  Next: Trouble,  Prev: Compatibility,  Up: Top
...
File: gcc-4.8.info,  Node: Gcov Intro,  Next: Invoking Gcov,  Up: Gcov
...
File: gcc-4.8.info,  Node: Invoking Gcov,  Next: Gcov and Optimization,  Prev: Gcov Intro,  Up: Gcov
...
File: gcc-4.8.info,  Node: Gcov and Optimization,  Next: Gcov Data Files,  Prev: Invoking Gcov,  Up: Gcov
...
File: gcc-4.8.info,  Node: Gcov Data Files,  Next: Cross-profiling,  Prev: Gcov and Optimization,  Up: Gcov
...
File: gcc-4.8.info,  Node: Cross-profiling,  Prev: Gcov Data Files,  Up: Gcov
