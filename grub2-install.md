File: *manpages*,  Node: grub2-install,  Up: (dir)
...
DESCRIPTION
       ...
       --boot-directory=DIR
              install GRUB images under the directory DIR/grub2 instead of the
       ...
       --target=TARGET
              ...
              mipsel-qemu_mips, powerpc-ieee1275, s390x-emu, sparc64-ieee1275,
