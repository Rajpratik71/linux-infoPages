File: *manpages*,  Node: ibhosts,  Up: (dir)
...
DESCRIPTION
       ibhosts  is  a script which either walks the IB subnet topology or uses
       an already saved topology file and extracts the CA nodes.
