File: *manpages*,  Node: ibrouters,  Up: (dir)
...
DESCRIPTION
       ibrouters is a script which either walks the IB subnet topology or uses
       an already saved topology file and extracts the router nodes.
