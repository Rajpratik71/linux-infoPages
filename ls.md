...
Next: Formatting file timestamps,  Prev: Details about version sort,  Up: ls invocation
...
Next: Formatting the file names,  Prev: General output formatting,  Up: ls invocation
...
Prev: Formatting file timestamps,  Up: ls invocation
...
‘--quoting-style=WORD’
     ...
     default may change to ‘shell-escape’ in a future version of this
     package.
