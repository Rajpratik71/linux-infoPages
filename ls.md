...
`--width=COLS'
     ...
     the output line, and that single output line will be delimited
...
`--time-style=STYLE'
    ...
    `iso'
          ...
          `2002-03-30 '), and ISO 8601-like month, day, hour, and
          minute for recent timestamps (e.g., `03-30 23:45').  These
          timestamps are uglier than `long-iso' timestamps, but they
          carry nearly the same information in a smaller space and
          their brevity helps `ls' output fit within traditional
          80-column output lines.  The following two `ls' invocations
          are equivalent:
    ...
    `locale'
          ...
          generate timestamps like `30. Mär 2002 ' and `30. Mär
          23:45'.
