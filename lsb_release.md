...
NOTES
       ...
       Detection  of  systems using a mix of packages from various distributions or releases is something of a black art; the current heuristic tends to assume that the installation is of the earliest dis‐
       tribution which is still being used by apt but that heuristic is subject to error.
