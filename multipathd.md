File: *manpages*,  Node: multipathd,  Up: (dir)
...
OPTIONS
       ...
       -n     Ignore  new  devices.  multipathd  will  not  create a multipath
              device unless the WWID for the device is already listed  in  the
              WWIDs file.
