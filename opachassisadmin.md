File: *manpages*,  Node: opachassisadmin,  Up: (dir)
...
Options
       ...
       -a action Specifies the action for the supplied file.  The  default  is
                 ...
                 For chassis upgrade:
                           ...
                           push      Ensures  firmware is in primary or alter‐
                                     nate.
                           ...
                           run       Ensures firmware is in primary  and  run‐
                                     ning.
                 ...
                 For chassis fmconfig :
                           ...
                           push      Ensures  the  configuration  file  is  in
                                     chassis.
                           ...
                           run       After push, restarts FM on master,  stops
                                     on secondary.
                           ...
                           runall    After push, restarts FM on all management
                                     modules.
                 ...
                 For chassis fmcontrol :
                           ...
                           run       Ensures FM running on master, stopped  on
                                     secondary.
                           ...
                           runall
                                     Ensures FM running on all management mod‐
                                     ules.
                           ...
                           restart   Restarts FM  on  master,  stops  on  sec‐
                                     ondary.
       ...
       -s securityFiles
                 ...
                 For   Chassis  fmgetsecurityfiles,  filename  to  upload  to.
                 Default is *.pem
...
Operation Details
       ...
       fmcontrol Allows the FM to be controlled on each chassis specified. The
...
Results
       ...
       opachassisadmin  implicitly  performs  its operations in parallel. How‐
