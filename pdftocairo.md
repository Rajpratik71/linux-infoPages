File: *manpages*,  Node: pdftocairo,  Up: (dir)
...
DESCRIPTION
       ...
       the page number and file type  appended  to  output-file  (except  when
       ...
       of the output format options (-png, -jpeg, -tiff, -pdf, -ps,  -eps,  or
       -svg) must be used.
