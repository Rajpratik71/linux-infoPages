File: *manpages*,  Node: pnminvert,  Up: (dir)
...
DESCRIPTION
       ...
       If the image is grayscale, pnminvert replaces a pixel with one of  com-
       plementary  brightness,  i.e.  if the original pixel has gamma-adjusted
