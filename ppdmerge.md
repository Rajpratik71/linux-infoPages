File: *manpages*,  Node: ppdmerge,  Up: (dir)
...
DESCRIPTION
       ...
       The -o option specifies the PPD file to create. If not  specified,  the
       merged  PPD  file is written to the standard output. If the output file
