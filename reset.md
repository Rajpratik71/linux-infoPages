File: *manpages*,  Node: reset,  Up: (dir)
...
COMPATIBILITY
       ...
       of these changes are because the TERMCAP variable  is  no  longer  sup-
       ported  under  terminfo-based  ncurses, which makes tset -S useless (we
