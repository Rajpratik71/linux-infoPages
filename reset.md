...
HISTORY
       ...
       Later  in 4.1BSD (December 1980), Mark Horton added a call to the tset program using the -I and -Q options, i.e., using that to improve the terminal modes.  With those options, that version of reset
