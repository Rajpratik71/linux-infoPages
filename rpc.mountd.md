File: *manpages*,  Node: rpc.mountd,  Up: (dir)
...
CONFIGURATION FILE
       ...
       [nfsd] sections of the /etc/nfs.conf configuration file.  Values recog‐
       nized in the [mountd] section include manage-gids,  descriptors,  port,
       threads,  reverse-lookup,  and  state-directory-path,  ha-callout which
