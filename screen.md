...
invoking shell.
   ...
   If '/var/run/utmp' is writable by 'screen', an appropriate record
will be written to this file for each window, and removed when the
window is closed.  This is useful for working with 'talk', 'script',
...
Next: Invoking Screen,  Prev: Overview,  Up: Top
...
Next: Customization,  Prev: Getting Started,  Up: Top
...
Next: Commands,  Prev: Invoking Screen,  Up: Top
...
Next: Colon,  Prev: Startup Files,  Up: Customization
...
Next: New Window,  Prev: Customization,  Up: Top
...
Next: Command Summary,  Up: Commands
...
Next: Selecting,  Prev: Commands,  Up: Top
...
Next: Screen Command,  Up: New Window
...
Next: Setenv,  Prev: Chdir,  Up: New Window
...
Next: Shell,  Prev: Screen Command,  Up: New Window
...
Next: Term,  Prev: Setenv,  Up: New Window
...
Next: Window Types,  Prev: Shell,  Up: New Window
...
Next: Window Groups,  Prev: Term,  Up: New Window
...
Prev: Window Types,  Up: New Window
...
Next: Session Management,  Prev: New Window,  Up: Top
...
Next: Other Window,  Up: Selecting
...
Next: Select,  Prev: Next and Previous,  Up: Selecting
...
Next: Windowlist,  Prev: Other Window,  Up: Selecting
...
Next: Regions,  Prev: Selecting,  Up: Top
...
Next: Lock,  Prev: Detach,  Up: Session Management
...
Next: Multiuser Session,  Prev: Power Detach,  Up: Session Management
...
Next: Session Name,  Prev: Lock,  Up: Session Management
...
Next: Acladd,  Up: Multiuser Session
...
Next: Aclchg,  Prev: Multiuser,  Up: Multiuser Session
...
Next: Acldel,  Prev: Acladd,  Up: Multiuser Session
...
Next: Aclgrp,  Prev: Aclchg,  Up: Multiuser Session
...
Next: Displays,  Prev: Acldel,  Up: Multiuser Session
...
Next: Umask,  Prev: Aclgrp,  Up: Multiuser Session
...
Next: Wall,  Prev: Displays,  Up: Multiuser Session
...
Next: Writelock,  Prev: Umask,  Up: Multiuser Session
...
Next: Su,  Prev: Wall,  Up: Multiuser Session
...
Prev: Writelock,  Up: Multiuser Session
...
Next: Suspend,  Prev: Multiuser Session,  Up: Session Management
...
Next: Quit,  Prev: Session Name,  Up: Session Management
...
Prev: Suspend,  Up: Session Management
...
Next: Window Settings,  Prev: Session Management,  Up: Top
...
Next: Only,  Prev: Split,  Up: Regions
...
Next: Remove,  Prev: Focus,  Up: Regions
...
Next: Resize,  Prev: Only,  Up: Regions
...
Next: Caption,  Prev: Remove,  Up: Regions
...
Next: Fit,  Prev: Resize,  Up: Regions
...
Next: Focusminsize,  Prev: Caption,  Up: Regions
...
Next: Layout,  Prev: Fit,  Up: Regions
...
Next: Virtual Terminal,  Prev: Regions,  Up: Top
...
Next: Dynamic Titles,  Up: Naming Windows
...
Next: Title Prompts,  Prev: Title Command,  Up: Naming Windows
...
Next: Title Screenrc,  Prev: Dynamic Titles,  Up: Naming Windows
...
Prev: Title Prompts,  Up: Naming Windows
...
Next: Kill,  Prev: Naming Windows,  Up: Window Settings
...
Next: Login,  Prev: Console,  Up: Window Settings
...
Next: Mode,  Prev: Kill,  Up: Window Settings
...
==========
 ...
 -- Command: login [state]
     ('C-a L')
     Adds or removes the entry in '/var/run/utmp' for the current
     window.  This controls whether or not the window is "logged in".
     In addition to this toggle, it is convenient to have "log in" and
     "log out" keys.  For instance, 'bind I login on' and 'bind O login
     off' will map these keys to be 'C-a I' and 'C-a O' (*note Key
     Binding::).

Next: Monitor,  Prev: Login,  Up: Window Settings
...
Next: Windows,  Prev: Mode,  Up: Window Settings
...
Next: Hardstatus,  Prev: Monitor,  Up: Window Settings
...
Next: Mousetrack,  Prev: Windows,  Up: Window Settings
...
Next: Copy and Paste,  Prev: Window Settings,  Up: Top
...
Next: Input Translation,  Up: Virtual Terminal
...
Next: Digraph,  Prev: Control Sequences,  Up: Virtual Terminal
...
Next: Bell,  Prev: Input Translation,  Up: Virtual Terminal
...
Next: Clear,  Prev: Digraph,  Up: Virtual Terminal
...
Next: Info,  Prev: Bell,  Up: Virtual Terminal
...
Next: Redisplay,  Prev: Clear,  Up: Virtual Terminal
...
Next: Wrap,  Prev: Info,  Up: Virtual Terminal
...
Next: Reset,  Prev: Redisplay,  Up: Virtual Terminal
...
Next: Window Size,  Prev: Wrap,  Up: Virtual Terminal
...
Next: Character Processing,  Prev: Reset,  Up: Virtual Terminal
...
Prev: Window Size,  Up: Virtual Terminal
...
Next: Subprocess Execution,  Prev: Virtual Terminal,  Up: Top
...
Next: Copy Mode Keys,  Prev: Line Termination,  Up: Copy
...
Next: Movement,  Prev: Scrollback,  Up: Copy
...
Next: Marking,  Prev: Copy Mode Keys,  Up: Copy
...
Next: Repeat count,  Prev: Movement,  Up: Copy
...
Next: Searching,  Prev: Marking,  Up: Copy
...
Next: Specials,  Prev: Repeat count,  Up: Copy
...
Next: Registers,  Prev: Copy,  Up: Copy and Paste
...
Next: Screen Exchange,  Prev: Paste,  Up: Copy and Paste
...
Next: History,  Prev: Registers,  Up: Copy and Paste
...
Prev: Screen Exchange,  Up: Copy and Paste
...
Next: Key Binding,  Prev: Copy and Paste,  Up: Top
...
Next: Using Exec,  Up: Subprocess Execution
...
Prev: Exec,  Up: Subprocess Execution
...
Next: Flow Control,  Prev: Subprocess Execution,  Up: Top
...
Next: Bind Examples,  Up: Key Binding
...
Next: Command Character,  Prev: Bind,  Up: Key Binding
...
Next: Help,  Prev: Bind Examples,  Up: Key Binding
...
Next: Bindkey,  Prev: Command Character,  Up: Key Binding
...
Next: Bindkey Examples,  Prev: Help,  Up: Key Binding
...
Next: Bindkey Control,  Prev: Bindkey,  Up: Key Binding
...
Prev: Bindkey Examples,  Up: Key Binding
...
Next: Termcap,  Prev: Key Binding,  Up: Top
...
Next: XON/XOFF,  Prev: Flow Control Summary,  Up: Flow Control
...
Next: Message Line,  Prev: Flow Control,  Up: Top
...
Next: Termcap Syntax,  Prev: Window Termcap,  Up: Termcap
...
Next: Termcap Examples,  Prev: Dump Termcap,  Up: Termcap
...
Next: Special Capabilities,  Prev: Termcap Syntax,  Up: Termcap
...
Next: Autonuke,  Prev: Termcap Examples,  Up: Termcap
...
Next: Obuflimit,  Prev: Special Capabilities,  Up: Termcap
...
Next: Character Translation,  Prev: Autonuke,  Up: Termcap
...
Next: Logging,  Prev: Termcap,  Up: Top
...
Next: Hardware Status Line,  Up: Message Line
...
Next: Last Message,  Prev: Privacy Message,  Up: Message Line
...
Next: Message Wait,  Prev: Hardware Status Line,  Up: Message Line
...
Prev: Last Message,  Up: Message Line
...
Next: Startup,  Prev: Message Line,  Up: Top
...
Next: Miscellaneous,  Prev: Logging,  Up: Top
...
Next: Startup Message,  Prev: echo,  Up: Startup
...
Next: String Escapes,  Prev: Startup,  Up: Top
...
Next: Bumpleft,  Prev: At,  Up: Miscellaneous
...
Next: Bumpright,  Prev: Break,  Up: Miscellaneous
...
Next: Collapse,  Prev: Bumpleft,  Up: Miscellaneous
...
Next: Debug,  Prev: Bumpright,  Up: Miscellaneous
...
Next: License,  Prev: Collapse,  Up: Miscellaneous
...
Next: Nethack,  Prev: Debug,  Up: Miscellaneous
...
Next: Nonblock,  Prev: License,  Up: Miscellaneous
...
Next: Number,  Prev: Nethack,  Up: Miscellaneous
...
Next: Time,  Prev: Nonblock,  Up: Miscellaneous
...
Next: Verbose,  Prev: Number,  Up: Miscellaneous
...
Next: Version,  Prev: Time,  Up: Miscellaneous
...
Next: Zombie,  Prev: Verbose,  Up: Miscellaneous
...
Next: Printcmd,  Prev: Version,  Up: Miscellaneous
...
Next: Rendition,  Prev: Zombie,  Up: Miscellaneous
...
Next: Sorendition,  Prev: Printcmd,  Up: Miscellaneous
...
Next: Attrcolor,  Prev: Rendition,  Up: Miscellaneous
...
Next: Setsid,  Prev: Sorendition,  Up: Miscellaneous
...
Next: Eval,  Prev: Attrcolor,  Up: Miscellaneous
...
Next: Maxwin,  Prev: Setsid,  Up: Miscellaneous
...
Next: Backtick,  Prev: Eval,  Up: Miscellaneous
...
Next: Screen Saver,  Prev: Maxwin,  Up: Miscellaneous
...
Next: Zmodem,  Prev: Backtick,  Up: Miscellaneous
...
Prev: Screen Saver,  Up: Miscellaneous
...
Prev: Hardstatus,  Up: Miscellaneous
...
Next: Environment,  Prev: Miscellaneous,  Up: Top
...
Next: Files,  Prev: String Escapes,  Up: Top
...
Next: Credits,  Prev: Environment,  Up: Top
...
=======
   ...
   This manual describes version 4.3.1 of the 'screen' program.  Its
...
Next: Installation,  Prev: Credits,  Up: Top
...
Next: Availability,  Prev: Known Bugs,  Up: Bugs
...
Next: Concept Index,  Prev: Bugs,  Up: Top
...
'/tmp/screens' or preferably to '/var/run/screen' chosen at
...
Prev: Socket Directory,  Up: Installation
...
Next: Command Index,  Prev: Installation,  Up: Top
...
Next: Keystroke Index,  Prev: Concept Index,  Up: Top
