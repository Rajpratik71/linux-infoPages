...
`-Q'
     ...
     The commands that can be queried now are:  `echo'  `info'
     `lastmsg'  `number'  `select'  `time'  `title'  `windows'
...
`-X'
     ...
     running. You can use the `-d' or `-r' option to tell screen to
     look only for attached or detached screen sessions. Note that this
...
==============
 ...
 -- Command: windowlist title [TITLE]
     ...
     are made by using the string setting.  The default setting is `Num
...
between detachments and reattachments.
 ...
 -- Command: layout `autosave' [`on'|`off']
     ...
     window. Without either an `on' or an `off', the current status is
...
command. *Note Copy::.
 ...
 -- Command: scrollback num
     ...
     NUM lines.  The default scrollback is 100 lines.  Use `info' to
...
`v' or `V' is for all the `vi' users who use `:set numbers' - it
...
============
 ...
 -- Command: defzombie [KEYS]
     ...
     window after the timeout.  It only works if zombie keys are
     defined via `zombie' command.
...
`SHELL'
     ...
     See also `shell' .screenrc command.
...
* compacthist:                           Scrollback.           (line 21)
...
* defmousetrack:                         Mousetrack.           (line 16)
* defnonblock:                           Nonblock.             (line 19)
* defobuflimit:                          Obuflimit.            (line 16)
* defscrollback:                         Scrollback.           (line 10)
* defshell:                              Shell.                (line  8)
* defsilence:                            Monitor.              (line 46)
* defslowpaste:                          Paste.                (line 41)
* defutf8:                               Character Processing. (line 99)
* defwrap:                               Wrap.                 (line 16)
...
* flow:                                  Flow.                 (line 15)
* focus:                                 Focus.                (line  7)
* focusminsize:                          Focusminsize.         (line  7)
* gr:                                    Character Processing. (line 18)
* group:                                 Window Groups.        (line 21)
