File: *manpages*,  Node: sg_persist,  Up: (dir)
...
OPTIONS
       ...
       -P, --preempt
              ...
              reservation is establised as a result of the preemption then the
              supplied  --prout-type=TYPE  is  used  as  the type for this new
              reservation.
