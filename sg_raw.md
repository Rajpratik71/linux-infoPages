File: *manpages*,  Node: sg_raw,  Up: (dir)
...
SYNOPSIS
       sg_raw  [--binary]  [--enumerate] [--help] [--infile=IFILE] [--nosense]
       [--outfile=OFILE]    [--readonly]    [--request=RLEN]     [--send=SLEN]
       [--skip=KLEN]  [--timeout=SEC] [--verbose] [--version] DEVICE CDB0 CDB1
       ...
