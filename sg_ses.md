File: *manpages*,  Node: sg_ses,  Up: (dir)
...
SYNOPSIS
       ...
       [--index=IIA | --index=TIA,II] [--inner-hex] [--join] [--list] [--nick‐
       name=SEN] [--nickid=SEID]  [--page=PG] [--raw]  [--set=STR]  [--status]
...
OPTIONS
       ...
       -N, --nickid=SEID
              ...
              (SEN)  will  be  applied to. The default value is 0 which is the
              main enclosure.
