File: *manpages*,  Node: sg_xcopy,  Up: (dir)
...
DESCRIPTION
       ...
       By default the XCOPY command is sent to IFILE. This can be changed with
       the --on_dst option which causes the XCOPY command to be sent to  OFILE
       instead.
...
OPTIONS
       ...
       bs=BS  where BS must be the block  size  of  the  physical  device  (if
       ...
       --on_src
              ...
              default when this option and --on_dst are not given.
