File: *manpages*,  Node: smartd,  Up: (dir)
...
DESCRIPTION
       ...
       On  startup,  in  the  absence of the configuration file /etc/smartmon‐
       tools/smartd.conf, the smartd daemon first scans for all  devices  that
...
OPTIONS
       ...
       -c FILE, --configfile=FILE
              ...
              /etc/smartmontools/smartd.conf'  can be used to verify the exis‐
              tence of the default configuration file.
       ...
       -D, --showdirectives
              ...
              may    appear   in   the   configuration   file   /etc/smartmon‐
              tools/smartd.conf,  and  then  exits.   These   Directives   are
              described  in  the  smartd.conf(5) man page.  They may appear in
       ...
       -q WHEN, --quit=WHEN
              ...
              errors  are  found  in  the  configuration  file  /etc/smartmon‐
              tools/smartd.conf at startup or whenever it is reloaded.
