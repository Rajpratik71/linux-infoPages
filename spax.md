File: *manpages*,  Node: spax,  Up: (dir)
...
SEE ALSO
       ...
       mkdir(2), mkfifo(3), stat(2), utime(2), write(2).
...
CHANGE HISTORY
   ...
   Issue 6
       ...
       mkdir(2) and mkfifo(3) calls can ignore an [EEXIST] error when extract‐
       ing an archive.
...
OTHER OPTIONS
       ...
       well described in star(1) manual page.
