File: *manpages*,  Node: systemd,  Up: (dir)
...
KERNEL COMMAND LINE
       ...
       systemd.confirm_spawn=
           ...
           confirmation messages should be emitted. If yes, the system manager
           (PID 1) asks for confirmation when spawning processes using
           /dev/console. If a path or a console name (such as "ttyS0") is
           provided, the virtual console pointed to by this path or described
           by the give name will be used instead. Defaults to no.
