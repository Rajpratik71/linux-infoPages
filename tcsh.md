File: *manpages*,  Node: tcsh,  Up: (dir)
...
REFERENCE
   ...
   Builtin commands
       ...
       limit [-h] [resource [maximum-use]]
               ...
               memoryuse
                      ...
                      in  the 2.6+ kernel, so there is no effect introduced by
                      changing this value)
   ...
   Special shell variables
       ...
       chronized in this manner, and that  the  shell  automatically  converts
       ...
       status  The  exit  status from the last command or backquote expansion,
               ...
               If  the  anyerror variable is unset, the exit status of a pipe‐
               line is determined only from the last command in the  pipeline,
               and  the exit status of a backquote expansion is not propagated
               to status.
