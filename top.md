...
OVERVIEW
   ...
   Operation
       ...
       key and quit ('q') key.  Alternatively, you could simply use the tradi-
...
1. COMMAND-LINE Options
       ...
       -w  :Output-width-override as:  -w [ number ]
            ...
            an argument with -w, when not in Batch mode actual terminal dimen-
...
3. FIELDS / Columns
   3a. DESCRIPTIONS of Fields
       ...
       16. PR  --  Priority
           ...
           field, it means the task is running under real time scheduling pri-
           ority.

           Under linux, real time priority is somewhat misleading since tradi-
           tionally  the  operating itself was not preemptible.  And while the
       ...
       31. TPGID  --  Tty Process Group Id
           ...
           tion, this value equals the process ID (see  PID)  of  the  process
       ...
       37. WCHAN  --  Sleeping in Function
           ...
           in which the task is currently sleeping.  Running tasks  will  dis-
           play a dash ('-') in this column.
       ...
       42. nsIPC  --  IPC namespace
           ...
           tion (IPC) resources such as System V IPC objects and POSIX message
           queues.
       ...
       45. nsPID  --  PID namespace
           The Inode of the namespace used to isolate process ID numbers mean-
           ing they need not remain unique.  Thus, each such  namespace  could
           have its own `init' (PID #1) to manage various initialization tasks
       ...
       line.
         ...
         <Enter> or <Space>  :Refresh-Display
          ...
          =  :Exit-Task-Limits
              ...
              command-line option for a discussion of PID monitoring, the  `U'
              or  `u'  interactive  commands for User filtering and the `O' or
          ...
          B  :Bold-Disable/Enable toggle
              ...
              window.  While it is intended primarily for use with dumb termi-
              nals, it can be applied anytime.
   ...
   4c. TASK AREA Commands
       ...
       CONTENT of task window
          ...
          V  :Forest-View-Mode toggle
              ...
              gram name and command line (see the `c' interactive command)  or
...
5. ALTERNATE-DISPLAY Provisions
   ...
   5b. COMMANDS for Windows
       ...
       *  = | +  :Equalize-(reinitialize)-Window(s)
              ...
              that might be active.  Also, if the window had been scrolled, it
              will be reset with this command.  See topic 5c. SCROLLING a Win-
              dow for additional information regarding vertical and horizontal
              scrolling.
              ...
              `o/O' (other filter) and scrolling interactive commands.
       ...
       *  a | w  :Next-Window-Forward/Backward
              ...
              cular  fashion  so you can reach any desired window using either
              key.
   ...
   5e. FILTERING in a Window
       ...
       dow is no longer subject to filtering.  See the `x' interactive command
...
7. STUPID TRICKS Sampler
   ...
   7c. The Big Bird Window
       ...
       ·  Display all 4 windows and make sure that 1:Def is the `current' win-
