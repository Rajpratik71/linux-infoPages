...
DESCRIPTION
   ...
   Options
       ...
       --TCC temperature sets the Thermal Control Circuit temperature for systems which do not export that value.  This is used for making sense of the Digital Thermal Sensor outputs, as  they  return  de‐
       grees Celsius below the TCC activation temperature.
...
TOO MUCH INFORMATION EXAMPLE
       By  default,  turbostat dumps all possible information -- a system configuration header, followed by columns for all counters.  This is ideal for remote debugging, use the "--out" option to save ev‐
       erything to a text file, and get that file to the expert helping you debug.
