File: *manpages*,  Node: verifytree,  Up: (dir)
...
DESCRIPTION
       verifytree is a program that verifies whether a local yum repository is
       consistent.
...
OPTIONS
       ...
       -r, --treeinfo
              Check the checksums of listed files  in  a  .treeinfo  file,  if
              available.
