File: *manpages*,  Node: vgcfgbackup,  Up: (dir)
...
DESCRIPTION
       vgcfgbackup  creates  back  up files containing metadata of VGs.  If no
       ...
       up  multiple  VGs,  the  file  name  is  treated as a template, with %s
...
OPTIONS
       ...
       -f|--file String
              ...
              one VG, the file name is treated as a template, and %s is
              replaced by the VG name.
