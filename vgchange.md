File: *manpages*,  Node: vgchange,  Up: (dir)
...
SYNOPSIS
       ...
       {y|n}]   [-a|--activate   [a|e|l]   {y|n}]   [--activationmode    {com-
       ...
       [--sysinit]   [--noudevsync]   [-l|--logicalvolume   MaxLogicalVolumes]
       [-p|--maxphysicalvolumes  MaxPhysicalVolumes]  [--metadataprofile  Pro-
       fileName]      [--[vg]metadatacopies]     NumberOfCopies|unmanaged|all]
       [-P|--partial]  [-s|--physicalextentsize  PhysicalExtentSize[bBsSkKmMg-
       GtTpPeE]]  [-S|--select  Selection]  [--systemid  SystemID] [--refresh]
