File: *manpages*,  Node: virt-install,  Up: (dir)
...
GENERAL OPTIONS
       ...
       --cpu MODEL[,+feature][,-feature][,match=MATCH][,vendor=VENDOR],...
           ...
           --cpu
           cell0.memory=1234,cell0.cpus=0-3,cell1.memory=5678,cell1.cpus=4-7
...
DEVICE OPTIONS
       ...
       --memdev OPTS
           ...
           details at <http://libvirt.org/formatdomain.html#elementsMemory>.
