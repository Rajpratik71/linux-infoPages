...
CUSTOMIZING XMAN
       ...
       For instance, a user has three directories in her manual path and each contain a directory called man3.  All these manual pages will appear alphabetically sorted when the user selects the menu  item
