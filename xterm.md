File: *manpages*,  Node: xterm,  Up: (dir)
...
RESOURCES
   ...
   VT100 Widget Resources
       ...
       ximFont (class XimFont)
               ...
               proper font.  The font is to be supplied by a "fontset",  whose
               default  value  is  "fixed"  on  openSUSE. The upstream default
               value is “*” which matches every font, the X library  automati-
               cally  chooses  fonts  with  proper  charsets.  But this can be
               extremely slow in some locales and at least for the XIM servers
               "scim" and "kinput2" it doesn't improve anything, it just slows
               down the startup time of xterm.

               The ximFont resource is provided to override this default  font
               setting.
