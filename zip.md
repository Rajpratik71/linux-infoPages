...
SYNOPSIS
       zip [-aABcdDeEfFghjklLmoOqrRSTuvVwXyz!@$] [--longoption ...]  [-b path]
...
OPTIONS
       ...
       --DOS-names
              ...
              sion from ISO8859-1 to IBM PC CP 852 is used. See also -OO
       ...
       -OO    File names will be converted  from  ISO8859-2  instead  of  from
